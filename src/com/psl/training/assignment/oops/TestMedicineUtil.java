...
/**
 * Assignment Date 12.1.21 Create a class Medicine to represent a drug
 * manufactured by a pharmaceutical company. Provide a function displayLabel()
 ...
 * 
 * Declare an array of Medicine references of size 10 Create a medicine object
 * of the type as decided by a randomly generated integer in the range 1 to 3.
 * Refer Java API Documentation to find out random generation feature. Check the
 * polymorphic behavior of the displayLabel() method.
 * 
